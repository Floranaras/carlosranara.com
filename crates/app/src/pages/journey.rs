        ...
        <div class="w-full flex flex-col items-center animate-fade-in-up">
            ...
            <div class="w-full max-w-[900px] text-center mb-20">
                ...
                <div class="flex flex-wrap justify-center gap-6 mt-8">
                    <div class="flex flex-col items-center">
                        ...
                        <span class="text-xs text-rose-pine-muted uppercase tracking-wider">
                            "Milestones"
                        </span>
                    </div>
                    <div class="flex flex-col items-center">
                        <span class="text-3xl font-bold text-rose-pine-foam">
                            {years.to_string()}
                        </span>
                        <span class="text-xs text-rose-pine-muted uppercase tracking-wider">
                            "Years"
            ...
            <div class="w-full max-w-[900px] relative">
                ...
                <div
                    ...
                    style="position: absolute; left: 50%; top: 0; bottom: 0; width: 2px; background: linear-gradient(to bottom, rgba(49,117,144,0.3), rgba(49,117,144,0.5), rgba(49,117,144,0.3)); transform: translateX(-50%);"
                ></div>
                ...
                <div class="space-y-16">
                    {items
                        .into_iter()
                        .enumerate()
                        .map(|(i, item)| view! { <TimelineCard item=item index=i /> })
                        .collect_view()}
                </div>
            </div>
            ...
            <div class="w-full max-w-[600px] text-center mt-32 mb-16 p-8 border border-primary/20 bg-rose-pine-surface/30 rounded-lg hover:border-primary/50 transition-all group">
                <div class="inline-flex items-center justify-center size-16 rounded-full bg-rose-pine-love/10 border border-rose-pine-love/20 mb-4 group-hover:scale-110 transition-transform">
                    <span class="material-symbols-outlined text-3xl text-rose-pine-love group-hover:animate-pulse">
                        "favorite"
                    </span>
                </div>
                <h3 class="text-2xl font-bold text-rose-pine-text mb-3">
            ...
            <div class=card_class>
                ...
                >
                    <div class="flex items-center gap-2 mb-3">
                        <span class="material-symbols-outlined text-sm text-rose-pine-muted">
                            "calendar_today"
                        </span>
                        <span class="text-[10px] text-rose-pine-muted uppercase tracking-wider">
                            {item.date}
                        </span>
                    </div>
                                            ...
                                            .map(|l| {
                                                view! {
                                                    <div class="pl-4 border-l-2 border-primary/30 bg-primary/5 p-3 rounded-r">
                                                        <p class="text-xs text-rose-pine-subtle uppercase tracking-wider mb-1">
                                                            "Lessons Learned"
                                                        </p>
                    ...
                    <div class="flex items-center gap-2 mt-4 text-xs text-rose-pine-muted">
                        ...
                        <span>
                            {move || if expanded.get() { "Show less" } else { "Click to expand" }}
                        </span>
                    </div>
                </div>
            </div>
