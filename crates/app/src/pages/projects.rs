        ...
        <div class="max-w-7xl mx-auto w-full animate-fade-in-up">
            ...
            <section class="mb-12">
                <div class="flex flex-col gap-2 border-l-4 border-primary pl-6 py-2">
                    ...
                    <h1 class="text-4xl md:text-5xl font-black text-rose-pine-text">
                        "/projects_"
                    </h1>
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
                                    ...
                                    <button
                                        class=move || {
                                            if active_cat.get() == cat_clone {
                                                "px-4 py-1 text-xs font-bold border transition-all uppercase border-primary bg-primary text-rose-pine-base"
                                                    .to_string()
                                            } else {
                                                "px-4 py-1 text-xs font-bold border transition-all uppercase border-rose-pine-muted/50 text-rose-pine-subtle hover:border-primary hover:text-primary"
                                                    .to_string()
                                            }
                                        }
                    ...
                    <div class="flex items-center gap-4 text-rose-pine-muted text-xs">
                        ...
                        <span
                            class=move || {
                                if layout.get() == "grid" {
                                    "material-symbols-outlined cursor-pointer text-primary"
                                } else {
                                    "material-symbols-outlined cursor-pointer hover:text-rose-pine-text"
                                }
                            }
                                            ...
                                            view! {
                                                ...
                                                >
                                                    <div class="relative p-6 bg-rose-pine-surface/30 transition-all border border-primary/30 hover:bg-rose-pine-surface/50 cursor-pointer">
                                                        <span class="absolute -top-1 -left-1 px-1 bg-rose-pine-base text-primary">
                                                            "+"
                                                        </span>
                                                        <span class="absolute -bottom-1 -right-1 px-1 bg-rose-pine-base text-primary">
                                                            "+"
                                                        </span>
                                                        ...
                                                        <div class="flex flex-col h-full">
                                                            <div class="flex justify-between items-start mb-4">
                                                                <span class=format!(
                                                                    "text-xs font-bold {color_class}",
                                                                )>{code}</span>
                                                            </div>

                                                            <div class="aspect-video mb-6 bg-rose-pine-overlay relative overflow-hidden flex items-center justify-center">
                                                                <div class=format!(
                                                                    "absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] {from_class} via-transparent to-transparent",
                                                                )></div>
                                                                {p
                                                                    .thumbnail
                                                                    .map(|src| {
                                                ...
                                                >
                                                    <div class="border border-rose-pine-muted/20 p-5 bg-rose-pine-surface/20 hover:border-rose-pine-muted/50 transition-colors">
                                                        <div class="flex justify-between mb-3">
                                                            <span class="material-symbols-outlined text-rose-pine-muted text-lg">
                                                                "folder"
                                                            </span>
                                                            <div class="flex gap-2">
                                                                <span class="material-symbols-outlined text-rose-pine-muted text-sm cursor-pointer hover:text-rose-pine-text transition-colors">
                                                                    "code"
                                                                </span>
                                                            </div>
                                                        </div>
                                                        <h4 class="font-bold text-rose-pine-text mb-2">
                                                            {p.title}
                                                        </h4>
                                                        <p class="text-rose-pine-muted text-xs mb-4 line-clamp-2">
                                                            {p.description}
                                                        </p>
                                                        <div class="flex justify-between items-center">
                                                            <span class=format!(
                                                                "text-[10px] uppercase font-bold {cat_color}",
